...
/*
    애니메이션 만들기
     ...
     2) 애니메이션 동작 후 스타일을 담을 classNane 설정
     3) transition으로 ?초 동안 변하게
     4) 원할 때 동작 전 className을 동작후 className으로 변경
*/
...
// 애니메이션
function TabContent({tab}) {    //{teb}에 0,1,2 들어있음
    let [fade, setFade] = useState('')

    useEffect(() => {               //처음에는 스타트를 붙혀주고 엔드를 붙혀줌 위에 app.css에 꾸며놓은거 있음
